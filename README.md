...
| 2024 | **Matrix-Transformation Based Low-Rank Adaptation (MTLoRA): A Brain-Inspired Method for Parameter-Efficient Fine-Tuning** |    arXiv   | [Link](https://arxiv.org/pdf/2403.07440) |  [Link](https://github.com/YaoLiang-Code/MTLoRA-main) | LPLMs; geometric structure； | meta learning; rank-1 matrix|
...
| 2024 | **LAMPAT: Low-Rank Adaption for Multilingual Paraphrasing Using Adversarial Training** |    AAAI   | [Link](https://arxiv.org/pdf/2401.04348) |  [Link](https://github.com/VinAIResearch/LAMPAT) |
